...
<form action="collegemanagereg" method="post" >
<div class="body"></div>
		<div class="grad"></div>
		<div class="header">
...
<input type="email" name="email" placeholder="College Email" ><br><br>
<input type="text" name="phone" placeholder=" College Contact Number" ><br><br>
<textarea type="text" name="caddress" placeholder="College Address" style="heigth:20px;"></textarea><br><br>
<input type="password" name="password1" placeholder="Password" id="password1" ><br><br>

<input type="password" name="password2" placeholder="Confirm Password" id="password2" onchange="validatepassword()"><br><br>
